...
import { Bot, LogIn, Mail, Lock, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-xl font-bold tracking-tight">AI Support Platform</h1>
        ...
        <p className="text-center text-xs text-muted-foreground">
          Chưa có tài khoản?{" "}
          <Link to="/signup" className="text-primary hover:underline font-medium">Đăng ký</Link>
        </p>
      </div>
    </div>
  );
