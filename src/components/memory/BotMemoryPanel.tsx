...
import {
  Brain, Plus, Search, BookOpen, Shield, Sparkles, MessageSquareWarning,
...
export default function BotMemoryPanel({ tenantId, compact = false }: BotMemoryPanelProps) {
  const { user } = useAuth();
        ...
        {!compact && (
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Rules, corrections, personality, constraints và skills cho chatbot
            </p>
          </div>
        )}
        {formDialog}
